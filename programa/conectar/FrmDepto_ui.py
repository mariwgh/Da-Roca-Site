...
class Ui_FrmDepto(object):
    def setupUi(self, FrmDepto):
        ...
        self.abas.setGeometry(QRect(10, 0, 491, 301))
        font = QFont()
        ...
        self.layoutWidget.setGeometry(QRect(0, 10, 371, 116))
        ...
        self.spbNumDepto = QSpinBox(self.layoutWidget)
        self.spbNumDepto.setObjectName(u"spbNumDepto")
        self.spbNumDepto.setMinimum(1)

        self.gridLayout.addWidget(self.spbNumDepto, 0, 1, 1, 1)
        ...
        self.edNomeDepto = QLineEdit(self.layoutWidget)
        self.edNomeDepto.setObjectName(u"edNomeDepto")
        self.edNomeDepto.setMaxLength(20)

        self.gridLayout.addWidget(self.edNomeDepto, 1, 1, 1, 1)
        ...
        self.edNumSegSocial = QLineEdit(self.layoutWidget)
        self.edNumSegSocial.setObjectName(u"edNumSegSocial")
        self.edNumSegSocial.setMaxLength(11)

        self.gridLayout.addWidget(self.edNumSegSocial, 2, 1, 1, 1)
        ...
        self.deDataInicialGerente = QDateEdit(self.layoutWidget)
        self.deDataInicialGerente.setObjectName(u"deDataInicialGerente")

        self.gridLayout.addWidget(self.deDataInicialGerente, 3, 1, 1, 1)
    ...
    def retranslateUi(self, FrmDepto):
        ...
        ___qtablewidgetitem.setText(QCoreApplication.translate("FrmDepto", u"Num. Depto", None));
        ...
        ___qtablewidgetitem2.setText(QCoreApplication.translate("FrmDepto", u"Id. Gerente", None));
        ___qtablewidgetitem3 = self.gridDepto.horizontalHeaderItem(3)
        ___qtablewidgetitem3.setText(QCoreApplication.translate("FrmDepto", u"Nome do Gerente", None));
